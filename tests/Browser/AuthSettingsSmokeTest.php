...
test('the two-factor challenge page is accessible and error free', function () {
    ...
    // Wait for the challenge page content before asserting, so axe never
    // runs against a document that is still mid-navigation (CI is slower
    // than local headless Chrome).
    $page->assertSee('code')
